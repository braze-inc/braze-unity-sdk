...
struct  X509NameType_t2588763298 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509NameType_t2588763298, ___value___1)); }
