...
struct  DefaultValueAttribute_t116041064  : public Attribute_t498693649
{
public:
...
public:
	inline static int32_t get_offset_of_DefaultValue_0() { return static_cast<int32_t>(offsetof(DefaultValueAttribute_t116041064, ___DefaultValue_0)); }
