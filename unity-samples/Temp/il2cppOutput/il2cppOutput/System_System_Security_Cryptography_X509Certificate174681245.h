...
struct  X509VerificationFlags_t174681245 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509VerificationFlags_t174681245, ___value___1)); }
