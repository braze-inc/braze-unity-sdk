...
struct  EnumeratorMode_t3331444647 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnumeratorMode_t3331444647, ___value___1)); }
