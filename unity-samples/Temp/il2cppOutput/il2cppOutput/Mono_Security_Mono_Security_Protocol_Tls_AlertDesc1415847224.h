...
struct  AlertDescription_t1415847224 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AlertDescription_t1415847224, ___value___1)); }
