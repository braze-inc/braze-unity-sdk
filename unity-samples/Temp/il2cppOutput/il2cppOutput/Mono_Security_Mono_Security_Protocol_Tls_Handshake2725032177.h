...
struct  ClientCertificateType_t2725032177 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ClientCertificateType_t2725032177, ___value___1)); }
