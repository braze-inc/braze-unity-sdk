...
struct  DSASignatureFormatter_t4109966685  : public AsymmetricSignatureFormatter_t77133537
{
public:
...
public:
	inline static int32_t get_offset_of_dsa_0() { return static_cast<int32_t>(offsetof(DSASignatureFormatter_t4109966685, ___dsa_0)); }
