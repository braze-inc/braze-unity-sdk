...
struct X509EnhancedKeyUsageExtension_t1622  : public X509Extension_t1608
{
	...
	OidCollection_t1619 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1622_StaticFields{
	...
	Dictionary_2_t56 * ___U3CU3Ef__switch$mapE_6;
};
