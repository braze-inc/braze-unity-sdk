...
struct ExtendedKeyUsageExtension_t1420  : public X509Extension_t1414
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1372 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1420_StaticFields{
	...
	Dictionary_2_t56 * ___U3CU3Ef__switch$map14_4;
};
