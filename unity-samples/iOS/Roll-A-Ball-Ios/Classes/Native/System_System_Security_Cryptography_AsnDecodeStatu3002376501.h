...
struct  AsnDecodeStatus_t3002376501 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AsnDecodeStatus_t3002376501, ___value___1)); }
