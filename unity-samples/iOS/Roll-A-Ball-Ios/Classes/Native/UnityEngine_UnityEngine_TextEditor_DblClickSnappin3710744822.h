...
struct  DblClickSnapping_t3710744822 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DblClickSnapping_t3710744822, ___value___1)); }
