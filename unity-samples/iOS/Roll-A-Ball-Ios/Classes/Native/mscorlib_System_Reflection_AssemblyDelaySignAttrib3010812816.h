...
struct  AssemblyDelaySignAttribute_t3010812816  : public Attribute_t498693649
{
public:
...
public:
	inline static int32_t get_offset_of_delay_0() { return static_cast<int32_t>(offsetof(AssemblyDelaySignAttribute_t3010812816, ___delay_0)); }
