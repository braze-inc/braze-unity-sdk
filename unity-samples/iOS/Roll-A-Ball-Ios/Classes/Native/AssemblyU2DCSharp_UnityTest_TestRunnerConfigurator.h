...
struct TestRunnerConfigurator_t264  : public Object_t
{
	// System.Boolean UnityTest.TestRunnerConfigurator::<isBatchRun>k__BackingField
	bool ___U3CisBatchRunU3Ek__BackingField_2;
	// System.Boolean UnityTest.TestRunnerConfigurator::<sendResultsOverNetwork>k__BackingField
	bool ___U3CsendResultsOverNetworkU3Ek__BackingField_3;
};
struct TestRunnerConfigurator_t264_StaticFields{
