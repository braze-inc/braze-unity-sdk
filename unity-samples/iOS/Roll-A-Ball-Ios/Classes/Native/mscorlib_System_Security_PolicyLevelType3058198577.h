...
struct  PolicyLevelType_t3058198577 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PolicyLevelType_t3058198577, ___value___1)); }
