...
struct  AppboyNotificationSubscriptionType_t12027852 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AppboyNotificationSubscriptionType_t12027852, ___value___1)); }
