...
struct  X509RevocationMode_t772207134 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(X509RevocationMode_t772207134, ___value___1)); }
