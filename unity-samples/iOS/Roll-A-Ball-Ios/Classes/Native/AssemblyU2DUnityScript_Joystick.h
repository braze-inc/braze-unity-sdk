...
struct Joystick_t441  : public MonoBehaviour_t2
{
	...
	Vector2_t198  ___fingerDownPos_13;
	...
	GUITexture_t440 * ___gui_16;
	// UnityEngine.Rect Joystick::defaultRect
	Rect_t442  ___defaultRect_17;
	// Boundary Joystick::guiBoundary
	Boundary_t439 * ___guiBoundary_18;
	// UnityEngine.Vector2 Joystick::guiTouchOffset
	Vector2_t198  ___guiTouchOffset_19;
	// UnityEngine.Vector2 Joystick::guiCenter
	Vector2_t198  ___guiCenter_20;
};
struct Joystick_t441_StaticFields{
	// Joystick[] Joystick::joysticks
	JoystickU5BU5D_t436* ___joysticks_2;
