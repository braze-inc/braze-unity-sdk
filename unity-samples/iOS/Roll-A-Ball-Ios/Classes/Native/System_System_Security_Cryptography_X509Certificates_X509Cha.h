...
struct X509ChainElementCollection_t1612;
...
struct X509Chain_t1539  : public Object_t
{
	...
	X509ChainElementCollection_t1612 * ___elements_1;
	...
	X509ChainPolicy_t1613 * ___policy_2;
	...
	X509ChainStatusU5BU5D_t1614* ___status_3;
	...
	X500DistinguishedName_t1605 * ___working_issuer_name_6;
	...
	AsymmetricAlgorithm_t1407 * ___working_public_key_7;
	...
	X509Certificate2Collection_t1610 * ___collection_11;
};
struct X509Chain_t1539_StaticFields{
	...
	X509ChainStatusU5BU5D_t1614* ___Empty_4;
