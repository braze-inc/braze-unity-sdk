...
struct SimpleCollator_t1805  : public Object_t
{
	...
	CodePointIndexer_t1790 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1790 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1805_StaticFields{
	...
	SimpleCollator_t1805 * ___invariant_1;
};
