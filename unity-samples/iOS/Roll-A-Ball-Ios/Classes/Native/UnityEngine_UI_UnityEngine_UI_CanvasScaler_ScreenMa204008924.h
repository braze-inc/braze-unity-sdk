...
struct  ScreenMatchMode_t204008924 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ScreenMatchMode_t204008924, ___value___1)); }
