...
struct  SecurityCompressionType_t1615155800 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SecurityCompressionType_t1615155800, ___value___1)); }
