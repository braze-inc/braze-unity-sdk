...
namespace UnityTest
{
    ...
    public class TestRunner : MonoBehaviour
    {
        ...
        private static string k_Prefix = "IntegrationTest";
        private static string k_StartedMessage = k_Prefix + " Started";
        private static string k_FinishedMessage = k_Prefix + " Finished";
        private static string k_TimeoutMessage = k_Prefix + " Timeout";
        private static string k_FailedMessage = k_Prefix + " Failed";
        private static string k_FailedExceptionMessage = k_Prefix + " Failed with exception";
        private static string k_IgnoredMessage = k_Prefix + " Ignored";
        private static string k_InterruptedMessage = k_Prefix + " Run interrupted";
