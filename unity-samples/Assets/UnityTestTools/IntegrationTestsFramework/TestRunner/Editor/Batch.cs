...
namespace UnityTest
{
    ...
    {
        private static string k_TestScenesParam = "-testscenes=";
        static string k_TargetPlatformParam = "-targetPlatform=";
        static string k_ResultFileDirParam = "-resultsFileDirectory=";
